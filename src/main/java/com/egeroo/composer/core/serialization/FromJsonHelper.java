...
import com.egeroo.composer.core.error.InvalidJsonException;
import com.egeroo.composer.core.error.UnsupportedParameterException;
...
public class FromJsonHelper {
    ...
    public JsonElement parse(final String json) {
        ...
        JsonObject parsedElement = new JsonObject();
        if (StringUtils.isNotBlank(json)) {
            parsedElement = this.parser.parse(json).getAsJsonObject();
        }
    ...
    public BigDecimal extractBigDecimalWithLocaleName(final String parameterName, final JsonElement element) {
        return this.helperDelegator.extractBigDecimalWithLocaleName(parameterName, element, new HashSet<String>());
    }
