...
public class DataValidatorBuilder {
    ...
    public DataValidatorBuilder longGreaterThanNumber(String paramName, Long number, int index) {
        ...
        if (this.value != null) {
            final Long longValue = Long.valueOf(this.value.toString());
            if ((longValue < number && index == 1) || (longValue < number + 1 && index > 1)) {
                final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
    ...
    public DataValidatorBuilder toLowerCaseStringValue() {
    	if(this.value != null) {
    		this.value = this.value.toString().toLowerCase();
    	}
        return this;
    }
    public DataValidatorBuilder inMinMaxLengthOf(final Integer min, final Integer max) {
        if (this.value == null && this.ignoreNullValue) { return this; }

        if (this.value != null) {
            final Integer number = this.value.toString().trim().length();
            if (number < min || number > max) {
                final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                        .append(this.parameter).append(".is.not.within.expected.range");
                final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
    ...
    /**
     * @author fandy.oktavianus
     * 
     * This method function is handle message for client transaction if have same office
     * 
     * @return - message error string
     */
    public DataValidatorBuilder integerNotSameAsNumber(Long number) {
        if (this.value == null && this.ignoreNullValue) { return this; }

        if (this.value != null) {
            final Long intValue = Long.valueOf(this.value.toString());
            if (intValue == number) {
            	final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                        .append(this.parameter).append(".equal.to.specified.number");
            	final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
                        .append(" must be not same as").append(number);
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
                        defaultEnglishMessage.toString(), this.parameter, intValue, number);
                this.dataValidationErrors.add(error);
            }
    ...
    /**
     * @author ahmad.fahryan
     * @since 18 Jan 2017 | Edited 6 Juni 2017
     * 
     * @param expression
     * @return string error message for regex validatioin
    **/
    public DataValidatorBuilder matchesRegex(final String expression) {
        if (this.value == null && this.ignoreNullValue) {
        	return this;
        } else if (this.value == null && !this.ignoreNullValue) {
        	return this;
        }

        final Pattern pattern = Pattern.compile(expression);
        final Matcher matcher = pattern.matcher(this.value.toString());
        if (this.value != null && !matcher.matches()) {
            final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                    .append(this.parameter).append(".does.not.match.regexp");
            final StringBuilder defaultEnglishMessage = new StringBuilder("The parameter ").append(this.parameter)
                    .append(" must match the provided regular expression [ ").append(expression).append(" ] ").append(".");
	...
	public DataValidatorBuilder validateDateAfterOrEqual(final LocalDate date) {
		...
		if (this.value != null && date != null) {
			final LocalDate dateVal = (LocalDate) this.value;
			if (dateVal.isBefore(date)) {
				final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".").append(this.parameter).append(".is.less.than.date");
				final StringBuilder defaultEnglishMessage = new StringBuilder("The ").append(this.parameter).append(" must be greter than or equal to provided date").append(date);
				final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(), defaultEnglishMessage.toString(), this.parameter, dateVal, date);
				this.dataValidationErrors.add(error);
			}
		}
		return this;
    ...
    public DataValidatorBuilder validateTimeAfter(final String date) {
        if (this.value == null && this.ignoreNullValue) { return this; }

        if (this.value != null && date != null) {
            if (LocalTime.now().isBefore( LocalTime.parse( date ) )) {
                final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                        .append(this.parameter).append(".is.less.than.time");
                final StringBuilder defaultEnglishMessage = new StringBuilder("The ").append(this.parameter)
                        .append(" must be less than provided time").append(date);
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
                        defaultEnglishMessage.toString(), this.parameter, date);
                this.dataValidationErrors.add(error);
            }
        }
        return this;
    ...
    //Added By Ahmad Fahryan - 7 Feb 2017
    public DataValidatorBuilder validateDateBeforeSevenTeenYears(final LocalDate date) {
        if (this.value == null && this.ignoreNullValue) { return this; }
        ...
        if (this.value != null && date != null) {
            ...
            if (date.isBefore(dateVal)) {
                final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".")
                        .append("You.Are.Not.Yet").append(".17.Years.Of.Age");
                final StringBuilder defaultEnglishMessage = new StringBuilder("The ").append(this.parameter)
                        .append(" must be less than provided date").append(date);
                final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(),
                        defaultEnglishMessage.toString(), this.parameter, dateVal, date);
    ...
    /**
     * @author ahmad.fahryan
     * @since 9 Maret 2017 | Edited 26 April 2017
     * 
     * This method function is handle message for account blocked if type blocked is Account
     * 
     * @return message error string
     */
    public DataValidatorBuilder isBlocked() {
    	if(this.value != null) {
            final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction because ").append(this.resource)
            	.append(" ( ").append(this.parameter).append(" ) is being Blocked until ").append(this.value);
            
            final StringBuilder defaultEnglishMessage = new StringBuilder("This ").append(this.resource)
            	.append("with Account Number ( ").append(this.parameter).append(" )").append(" is being blocked periodly until.").append(this.value);
            
            defaultEnglishMessage.append(" Because another reason, please contact administrator");

            final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(), defaultEnglishMessage.toString(), this.parameter);
            this.dataValidationErrors.add(error);
    	} else {
            final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction because ").append(this.resource)
            	.append(" ( ").append(this.parameter).append(" ) is being Blocked Permanently.");
            
            final StringBuilder defaultEnglishMessage = new StringBuilder("This ").append(this.resource)
            	.append(" with Account Number ( ").append(this.parameter).append(" )").append(" is being blocked permanently.");
     ...
     * @since 9 Maret 2017
     * 
     * This method function is handle message for account transaction if type transaction is credit or debit
     * 
     * @param isDebit - this param value is true or false
     * @return - message error string
     */
    public DataValidatorBuilder isBlockedCreditOrDebit(Boolean isDebit) {
    	if(isDebit) {
    		final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction for ").append(this.resource)
    			.append(" ( ").append(this.parameter).append(" ) because is being Blocked ").append("by restriction Debit.");
            
            final StringBuilder defaultEnglishMessage = new StringBuilder("This ").append(this.resource)
            	.append(" with Account Number ( ").append(this.parameter).append(" )").append(" is being blocked by restriction Debit.");
    		...
    		final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction for ").append(this.resource)
    			.append(" ( ").append(this.parameter).append(" ) because is being Blocked ").append("by restriction Credit.");
            
            final StringBuilder defaultEnglishMessage = new StringBuilder("This ").append(this.resource)
            	.append(" with Account Number ( ").append(this.parameter).append(" )").append(" is being blocked by restriction Credit.");
    ...
    /**
     * @author ahmad.fahryan
     * @since 13 Maret 2017 | Edited 26 April 2017
     * 
     * This method function is handle message for account blocked if type blocked is balance
     * 
     * @param blockingAccountDurationTill - this param value is duration account blocked
     * @return - message error string
     */
    public DataValidatorBuilder isMaxBlockedAmount(String blockingAccountDurationTill) {
    	if(blockingAccountDurationTill != null) {
    		final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction for ").append(this.resource)
    			.append(" ( ").append(this.parameter).append(" ) because insufficient balance").append(" until ").append(blockingAccountDurationTill);
            
            final StringBuilder defaultEnglishMessage = new StringBuilder("This ").append(this.resource).append(" ( ").append(this.parameter).append(" ) savings balance")
            		.append(" has been Blocked").append(this.value).append(" until ").append(blockingAccountDurationTill);
    		...
    		final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction for ").append(this.resource)
    			.append(" ( ").append(this.parameter).append(" ) because insufficient balance Permanently. ");
            
            final StringBuilder defaultEnglishMessage = new StringBuilder("This ").append(this.resource).append(" ( ").append(this.parameter).append(" ) savings balance")
            		.append(" has been Blocked").append(this.value);
     ...
     * @since 9 Maret 2017 | Edited 26 April 2017
     * 
     * This method function is handle message for account blocked if type blocked is Account Reference
     * 
     * @return message error string
     */
    public DataValidatorBuilder isBlockedAcccountReference() {
    	if(this.value != null) {
            final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction for reference ").append(this.resource)
            	.append(" ( ").append(this.parameter).append(" ) because is being Blocked until ").append(this.value);
            ...
            final StringBuilder validationErrorCode = new StringBuilder("You cant do this transaction for reference ").append(this.resource)
            	.append(" ( ").append(this.parameter).append(" ) because is being Blocked Permanently.");
	...
	public DataValidatorBuilder decimalScaleLessThan(final int scale) {
		if (this.value != null) {
			final BigDecimal decimal = BigDecimal.valueOf(Double.valueOf(this.value.toString()));
			if (decimal.stripTrailingZeros().scale() > scale) {
				final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".").append(this.parameter).append(".scale.is.bigger.than.allowed");
				final StringBuilder defaultEnglishMessage = new StringBuilder("The ").append(this.parameter).append(" scale for ").append(decimal).append(" must be less than ").append(scale).append(".");
				final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(), defaultEnglishMessage.toString(), this.parameter, decimal, scale);
				this.dataValidationErrors.add(error);
				return this;
			}
		}
	...
	public DataValidatorBuilder isFileWithExtensions(final String[] extensions) {
		if (this.value != null) {
			final String fileName = this.value.toString();
			final String[] splittedName = fileName.split("\\.");
			if (splittedName.length > 1) {
				final String fileExtension = splittedName[splittedName.length - 1];
				boolean match = false;
				...
				if (!match) {
					final StringBuilder validationErrorCode = new StringBuilder("validation.msg.").append(this.resource).append(".").append(this.parameter).append(".file.type.not.allowed");
					final StringBuilder defaultEnglishMessage = new StringBuilder("The ").append(this.parameter).append(" must be type of ").append(String.join(", ", extensions)).append(".");
					final ApiParameterError error = ApiParameterError.parameterError(validationErrorCode.toString(), defaultEnglishMessage.toString(), this.parameter, String.join(", ", extensions));
					this.dataValidationErrors.add(error);
					return this;
				}
			}
